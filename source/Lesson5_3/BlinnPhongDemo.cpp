...
namespace Rendering
{
	...
	BlinnPhongDemo::BlinnPhongDemo(Game& game, shared_ptr<Camera> camera) :
	...
	void BlinnPhongDemo::Initialize()
	{
		...
		shaders.push_back(ShaderDefinition(GL_VERTEX_SHADER, "Content/Effects/BlinnPhongDemo.vert"));
		shaders.push_back(ShaderDefinition(GL_FRAGMENT_SHADER, "Content/Effects/BlinnPhongDemo.frag"));
