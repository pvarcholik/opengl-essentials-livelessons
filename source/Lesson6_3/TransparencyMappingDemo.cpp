...
namespace Rendering
{
	...
	TransparencyMappingDemo::TransparencyMappingDemo(Game& game, shared_ptr<Camera> camera) :
	...
	void TransparencyMappingDemo::Initialize()
	{
		...
		shaders.push_back(ShaderDefinition(GL_VERTEX_SHADER, "Content/Effects/TransparencyMappingDemo.vert"));
		shaders.push_back(ShaderDefinition(GL_FRAGMENT_SHADER, "Content/Effects/TransparencyMappingDemo.frag"));
