...
namespace Rendering
{
	...
	WrappingModesDemo::WrappingModesDemo(Game& game, shared_ptr<Camera> camera) :
	...
	void WrappingModesDemo::Initialize()
	{
		...
		shaders.push_back(ShaderDefinition(GL_VERTEX_SHADER, "Content/Effects/WrappingModesDemo.vert"));
		shaders.push_back(ShaderDefinition(GL_FRAGMENT_SHADER, "Content/Effects/WrappingModesDemo.frag"));
	...
	void WrappingModesDemo::CreateIndexBuffer(const uint32_t* indices, uint32_t indexCount, GLuint& indexBuffer)
	{
